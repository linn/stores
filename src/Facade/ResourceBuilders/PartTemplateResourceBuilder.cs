namespace Linn.Stores.Facade.ResourceBuilders
{
    ...
    public class PartTemplateResourceBuilder : IResourceBuilder<ResponseModel<PartTemplate>>
    {
        ...
        private IEnumerable<LinkResource> BuildLinks(ResponseModel<PartTemplate> model)
        {
            ...
            {
                yield return new LinkResource { Rel = "inventory/part-templates/create", Href = this.GetLocation(model) };
                yield return new LinkResource { Rel = "inventory/part-templates/edit", Href = this.GetLocation(model) };
            }
