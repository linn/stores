...
export const consignmentActionTypes = makeActionTypes(itemTypes.consignment.actionType, true);
...
export const saveConsignmentDocumentsActionTypes = makeProcessActionTypes(
