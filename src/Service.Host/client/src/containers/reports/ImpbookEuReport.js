...
import ImpbookIEuReport from '../../components/reports/ImpbookIprReport';
...
export default connect(mapStateToProps, mapDispatchToProps)(initialiseOnMount(ImpbookIEuReport));
