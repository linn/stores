namespace Linn.Stores.Service.Tests.ConsignmentModuleSpecs
{
    ...
    public class WhenSavingConsignmentDocuments : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            this.LogisticsProcessesFacadeService.SaveConsignmentDocuments(Arg.Any<ConsignmentRequestResource>())
        ...
        {
            this.LogisticsProcessesFacadeService.Received().SaveConsignmentDocuments(
