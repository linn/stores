namespace Linn.Stores.Service.Tests.SalesOutletModule
{
    ...
    public class WhenGettingOutletsByOrderNumbers : ContextBase
    {
        [SetUp]
        public void SetUp()
        {
            ...
            this.SalesOutletService.GetByOrders(Arg.Any<int[]>()).Returns(
                ...
                with =>
                    {
                        ...
                        with.Query("orderNumbers", "436702,437248");
                    }).Result;
        }
        ...
        {
            this.SalesOutletService.Received().GetByOrders(Arg.Any<int[]>());
        }
