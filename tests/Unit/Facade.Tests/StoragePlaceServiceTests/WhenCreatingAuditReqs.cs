namespace Linn.Stores.Facade.Tests.StoragePlaceServiceTests
{
    ...
    public class WhenCreatingAuditReqs : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            this.StoragePlaceAuditPack.CreateAuditReq("SP", 33067, this.resource.Department).Returns("SUCCESS");

            this.Sut.CreateAuditReqs(this.resource);
        }

        [Test]
        public void ShouldCallRepository()
        {
            this.StoragePlaceRepository.Received().FilterBy(Arg.Any<Expression<Func<StoragePlace, bool>>>());
        }

        [Test]
        public void ShouldCallAuditPack()
        {
            this.StoragePlaceAuditPack.Received().CreateAuditReq("SP", 33067, this.resource.Department);
        }
    }
}
